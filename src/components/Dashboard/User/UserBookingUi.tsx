    ...
    <div className="p-2">
      <div className="flex items-center gap-x-2 justify-center mb-3">
        <button
          ...
          className={`${toggleBooking==="pass" ?"bg-green-500":"bg-orange-500"} p-1 text-white rounded-sm`}
        >
          Pass Booking
        </button>
        <button
          onClick={() => setToggleBooking("upcoming")}
          className={`${toggleBooking==="upcoming" ?"bg-green-500":"bg-orange-500"} p-1 text-white rounded-sm`}
        >
          Upcoming Booking
        </button>
      </div>
